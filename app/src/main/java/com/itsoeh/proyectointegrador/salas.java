...
import com.itsoeh.proyectointegrador.adapter.AdapterSalas;
 ...
 * Use the {@link salas#newInstance} factory method to
 * create an instance of this fragment.
 */
public class salas extends Fragment {
    private RecyclerView rec;
    private AdapterSalas adapter;
    ...
    private ArrayList<MSalas> llenadoDesdeBD() {

        ArrayList<MSalas> lista=new ArrayList<MSalas>();
        ...
        StringRequest solicitud= new StringRequest(Request.Method.POST, API.GETSALAS,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            MSalas obj=new MSalas();
                            for (int i = 0; i < array.length(); i++) {
                                obj=new MSalas();
                                JSONObject pos=new JSONObject(array.getString(i));
                                obj.setId_sala(pos.getInt("idSala"));
                                obj.setNombre(pos.getString("nombre"));
                                obj.setPrecio(pos.getDouble("precio"));
                                obj.setCantidad_disponible(pos.getInt("cantidadDisponible"));
                            ...
                            adapter=new AdapterSalas(lista);
            ...
            protected Map<String, String> getParams() {
                ...
                //NO UTILIZAMOS NINGUN PARAMETRO
                return param;
            }
        };
        //ENVIA LA SOLICITUD
     ...
     * @return A new instance of fragment salas.
     */
    // TODO: Rename and change types and number of parameters
    public static salas newInstance(String param1, String param2) {
        salas fragment = new salas();
